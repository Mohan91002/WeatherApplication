...
const HI: Dict = {
  ...
  outlookEyebrow: 'पूर्वानुमान · अगले 7 दिन',
  outlookTitle: '7-दिन का पूर्वानुमान',
  refresh: 'ताज़ा करें',
...
const ES: Dict = {
  ...
  outlookEyebrow: 'PRONÓSTICO · PRÓXIMOS 7 DÍAS',
  outlookTitle: 'Pronóstico de 7 Días',
  refresh: 'actualizar',
...
const FR: Dict = {
  ...
  outlookEyebrow: 'PRÉVISIONS · 7 PROCHAINS JOURS',
  outlookTitle: 'Prévisions sur 7 Jours',
  refresh: 'actualiser',
...
const AR: Dict = {
  ...
  outlookEyebrow: 'التوقعات · الأيام الـ7 القادمة',
  outlookTitle: 'توقعات 7 أيام',
  refresh: 'تحديث',
